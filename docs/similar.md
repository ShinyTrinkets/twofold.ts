...
TwoFold is an exceptionally unique application, a hybrid between a text expander, a template engine
and a mini programming language. Personally, I have never found anything like it.
